...
import { IonContent, IonText, IonGrid, IonRow, IonCol, IonHeader, IonTitle} from '@ionic/angular/standalone';
...
@Component({
  ...
  imports: [CommonModule, IonContent, IonText, IonGrid, IonRow, IonCol, StockCardComponent, IonHeader, IonTitle],
})
